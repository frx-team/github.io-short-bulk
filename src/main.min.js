function frxteam(attr) {
	var a = document.getElementById("inputurl").value;
	var b = $('#inputurl').val().split('\n');
	var c = b.length;
	if(a === '') {} else {
	    if(attr == 'bnc') {
	        if(d == '') {
	            alert('Branch KEY Required');
	        } else {
    	        $('#shortbnc').attr('disabled', '');
        	    $('#inputbitly').attr('disabled', '');
        	    $('#inputjmp').attr('disabled', '');
        	    $('#inputshrlc').attr('disabled', '');
        	    $('#inputtinyurl').attr('disabled', '');
        		var countprocess = 0;
        		mulshortgoobnc();
        		document.getElementById("total").innerHTML = b.length;
        		function mulshortgoobnc() {
        			if(countprocess < c) {
        				$.post("frxteam.php", {
        				    "action": "bnclt",
        				    "longlink": b[countprocess],
        				    "key": d
        				}, function(response) {
        				    var frxshort = JSON.parse(response);
        				    if(frxshort.i == '0') {
        				        alert('Error...!!!');
        				    } else {
            				    document.getElementById("urlshort").value += frxshort.short + "\n";
            					document.getElementById("urldebug").value += "https://l.facebook.com/l.php?u=" + frxshort.short + "&h=" + makeid(25) + "&s=1" + "\n";
            					document.getElementById("urlifb").value += "https://web.facebook.com/flx/warn/?u=" + frxshort.short + "&h=" + makeid(25) + "&s=1" + "\n";
            					document.getElementById("debugig").value += "https://www.instagram.com/?u=" + frxshort.short + "&h=" + makeid(25) + "&s=1" + "\n";
    					        document.getElementById("urlweb").value += "https://www.instagram.com/linkshim/?u=" + response.data + "&e=" + iyo() + "&s=1"  + "\n";
            					countprocess++;
            					document.getElementById("loding").innerHTML = countprocess;
            					setTimeout(function(){
            						mulshortgoobnc();
            					}, 1000);
        				    }
    		...
    		mulshortgoo();
    		document.getElementById("total").innerHTML = b.length;
    		function mulshortgoo() {
    			if(countprocess < c) {
    				$.get("https://www.shareaholic.com/v2/share/shorten_link?apikey=8943b7fd64cd8b1770ff5affa9a9437b&service[name]=" + attr + "&url=" + b[countprocess] , function(response) {
    				    document.getElementById("urlshort").value += response.data + "\n";
    					document.getElementById("urldebug").value += "https://l.facebook.com/l.php?u=" + response.data + "&h=" + makeid(25) + "&s=1" + "\n";
    					document.getElementById("urlifb").value += "https://web.facebook.com/flx/warn/?u=" + response.data + "&h=" + makeid(25) + "&s=1" + "\n";
    					document.getElementById("urlig").value += "https://l.instagram.com/?u=" + response.data + "&e=" + cuk + "&s=1"  + "\n";
    					document.getElementById("urlweb").value += "https://www.instagram.com/linkshim/?u=" + response.data + "&e=" + iyo() + "&s=1"  + "\n";
    					countprocess++;
    					document.getElementById("loding").innerHTML = countprocess;
    					setTimeout(function(){
...
function frxdiv(attrdiv) {
    if(attrdiv == 'defaultinput') {
        document.getElementById("defaultinput").setAttribute("class", "btn btn-success btn-xs");
        document.getElementById("debuginput").setAttribute("class", "btn btn-default btn-xs");
        document.getElementById("debugifb").setAttribute("class", "btn btn-default btn-xs");
        document.getElementById("debugig").setAttribute("class", "btn btn-default btn-xs");
        document.getElementById("debugigweb").setAttribute("class", "btn btn-default btn-xs");
        document.getElementById("input-default").setAttribute("style", "btn btn-info btn-xs");
        document.getElementById("input-debug").setAttribute("style", "display: none;");
        document.getElementById("input-debugig").setAttribute("style", "display: none;");
        document.getElementById("input-debugifb").setAttribute("style", "display: none;");
        document.getElementById("input-debugigweb").setAttribute("style", "display: none;");
    } else if(attrdiv == 'debuginput') {
        document.getElementById("defaultinput").setAttribute("class", "btn btn-default btn-xs");
        document.getElementById("debuginput").setAttribute("class", "btn btn-success btn-xs");
        document.getElementById("debugifb").setAttribute("class", "btn btn-default btn-xs");
        document.getElementById("debugig").setAttribute("class", "btn btn-default btn-xs");
        document.getElementById("debugigweb").setAttribute("class", "btn btn-default btn-xs");
        document.getElementById("input-default").setAttribute("style", "display: none;");
        document.getElementById("input-debugifb").setAttribute("style", "display: none;");
        document.getElementById("input-debugig").setAttribute("style", "display: none;");
        document.getElementById("input-debugigweb").setAttribute("style", "display: none;");
        document.getElementById("input-debug").setAttribute("style", "");
    } else if(attrdiv == 'debugifb') {
        document.getElementById("defaultinput").setAttribute("class", "btn btn-default btn-xs");
        document.getElementById("debuginput").setAttribute("class", "btn btn-default btn-xs");
        document.getElementById("debugifb").setAttribute("class", "btn btn-success btn-xs");
        document.getElementById("debugig").setAttribute("class", "btn btn-default btn-xs");
        document.getElementById("debugigweb").setAttribute("class", "btn btn-default btn-xs");
        document.getElementById("input-default").setAttribute("style", "display: none;");
        document.getElementById("input-debug").setAttribute("style", "display: none;");
        document.getElementById("input-debugig").setAttribute("style", "display: none;");
        document.getElementById("input-debugigweb").setAttribute("style", "display: none;");
        document.getElementById("input-debugifb").setAttribute("style", "");
    } else if(attrdiv == 'debugig') {
        document.getElementById("defaultinput").setAttribute("class", "btn btn-default btn-xs");
        document.getElementById("debuginput").setAttribute("class", "btn btn-default btn-xs");
        document.getElementById("debugifb").setAttribute("class", "btn btn-default btn-xs");
        document.getElementById("debugig").setAttribute("class", "btn btn-success btn-xs");
        document.getElementById("debugigweb").setAttribute("class", "btn btn-default btn-xs");
        document.getElementById("input-default").setAttribute("style", "display: none;");
        document.getElementById("input-debug").setAttribute("style", "display: none;");
        document.getElementById("input-debugifb").setAttribute("style", "display: none;");
        document.getElementById("input-debugigweb").setAttribute("style", "display: none;");
        document.getElementById("input-debugig").setAttribute("style", "");
    } else if(attrdiv == 'debugigweb') {
        document.getElementById("defaultinput").setAttribute("class", "btn btn-default btn-xs");
        document.getElementById("debuginput").setAttribute("class", "btn btn-default btn-xs");
        document.getElementById("debugifb").setAttribute("class", "btn btn-default btn-xs");
        document.getElementById("debugig").setAttribute("class", "btn btn-default btn-xs");
        document.getElementById("debugigweb").setAttribute("class", "btn btn-success btn-xs");
        document.getElementById("input-default").setAttribute("style", "display: none;");
        document.getElementById("input-debug").setAttribute("style", "display: none;");
        document.getElementById("input-debugifb").setAttribute("style", "display: none;");
        document.getElementById("input-debugig").setAttribute("style", "display: none;");
        document.getElementById("input-debugigweb").setAttribute("style", "");
    }
}
...
function ok(length) {
   var result           = 'AT3V_QZ8oJvl0ScXJdKdB-xW232eFgsBv0aar4nui-6p1ERUD4svM2uFQL3sHRUjDxXnspjs0GE2NcLoyINHKcKot44LHpec2nWr';
   var characters       = '';
   var charactersLength = characters.length;
   for ( var i = 0; i < length; i++ ) {
      result += characters.charAt(Math.floor(Math.random() * charactersLength));
...
function iyo(length) {
   var result           = 'AT0juSC49V7oRlEXuW_Id5Rk8E2O2HSaQeZ31xmnA9jWDiBR96Zc6KmKrah8bkmhcHWGIXiImVZsMNWzHbJ8A78OAnooypytkeRW';
   var characters       = '';
   var charactersLength = characters.length;
   for ( var i = 0; i < length; i++ ) {
      result += characters.charAt(Math.floor(Math.random() * charactersLength));
